          ...
          <div className="hidden md:flex items-center gap-2">
            {isLoggedIn ? (
              <DropdownMenu modal={false}>
                ...
                <DropdownMenuContent align="end" className="navbar-dropdown-content p-0 border-0">
                  ...
                  <button className="navbar-dropdown-logout" onClick={logOutHandler}>
            ...
            <DropdownMenuContent align="end" className="navbar-dropdown-content p-0 border-0">
              ...
              {isLoggedIn ? (
                <>
                  ...
                  <div style={{ borderTop: "1px solid #f3f4f6", margin: "4px 0" }} />
                  <button className="navbar-mobile-logout" onClick={logOutHandler}>
                    <LogOut className="h-4 w-4" /> Logout
                  </button>
                </>
              ) : (
                <>
                  <Link to="/login" className="navbar-mobile-item">Login</Link>
                  <Link to="/signup" className="navbar-mobile-item">Sign Up</Link>
                </>
              )}
            </DropdownMenuContent>
          </DropdownMenu>
